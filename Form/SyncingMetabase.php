        ...
        protected function buildForm()
        {
            ...
            $this->formBuilder
                ...
                ->add('syncingTime', NumberType::class, [
                    ...
                    'label_attr'  => [
                        'help' => $translator->trans('Hour of Daily syncing or Minute past the Hourly syncing', [],
                ...
                ->add('refingerprint', CheckboxType::class, [
